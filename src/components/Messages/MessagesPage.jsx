...
import { Search, Send, Phone, Video, MoreHorizontal, Smile, Trash2 } from 'lucide-react';
                  ...
                  {getCurrentConversation().length === 0 ? (
                    ...
                    getCurrentConversation().map((msg) => (
                      <div key={msg.id} className={`flex ${msg.senderEmail === currentUser.email ? 'justify-end' : ''}`}>
                        ...
                        <div className={`px-4 py-2 rounded-2xl max-w-xs relative group ${
                          msg.senderEmail === currentUser.email
                          ...
                          <div className="flex items-center justify-between mt-1">
                            ...
                            {msg.senderEmail === currentUser.email && (
                              <button
                                ...
                                className="opacity-0 group-hover:opacity-100 transition-opacity ml-2 p-1 hover:bg-red-500 rounded"
