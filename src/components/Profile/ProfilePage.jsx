...
import { Calendar, MapPin, Link, Edit, Camera, UserPlus, UserMinus, Trash2 } from 'lucide-react';
...
const ProfilePage = ({ 
  ...
  const userPosts = posts.filter(post => 
    post.userId === currentUser.id || post.authorEmail === currentUser.email
  );
                    ...
                    <div className="flex space-x-3">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <button
                            className="p-1 hover:bg-red-50 rounded-full text-red-600 hover:text-red-700 transition-colors"
                            title="Delete post"
                            onClick={() => {
